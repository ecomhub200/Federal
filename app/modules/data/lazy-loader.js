...
export const R2_REQUIRED_TABS = new Set([
...
export const SUPABASE_ONLY_TABS = new Set([
...
export function tabNeedsR2(tabId) {
    ...
    try {
        var _tier = (typeof window.jurisdictionContext !== 'undefined' && window.jurisdictionContext.viewTier) || 'county';
...
export function isR2Loaded() {
    return _r2Loaded || !_enabled;
}

export function markR2Loaded() {
    _r2Loaded = true;
    _r2LoadPromise = null;
}
 ...
 */
export function ensureR2Loaded(requestingTabId) {
