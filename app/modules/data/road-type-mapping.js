...
CL.data.roadTypeMapping = (function () {
    ...
    function _isAggregateTier(tier) {
     ...
     */
    function specFor(tier, radio) { return get(tier, radio).spec; }
    function labelFor(tier, radio) {
        var c = get(tier, radio);
        return '<strong>' + c.label + '</strong> - ' + c.hint;
    }
    function suffixFor(tier, radio) { return get(tier, radio).r2Suffix; }
